...
<a href="<?php echo e(base_url('app/sponsorship/status_pencairan')); ?>"><i class="mdi mdi-arrow-left"></i></a> Detail Kegiatan
...
<li class="breadcrumb-item"><a href="<?php echo e(base_url('app/sponsorship')); ?>"><i class="mdi mdi-briefcase-outline"></i> Sponsorship</a></li>
<li class="breadcrumb-item"><a href="<?php echo e(base_url('app/sponsorship/pencairan')); ?>"><i class="mdi mdi-cash-register"></i> Pencairan</a></li>
<li class="breadcrumb-item"><a href="<?php echo e(base_url('app/sponsorship/status_pencairan')); ?>"><b><i class="mdi mdi-file-document-outline"></i> <?php echo e($data->kode_uraian); ?></a></b></li>
...
<div class="col-md-12">
    <div class="card card-border card-teal">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo e($data->nama_kegiatan); ?></p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="">Deskripsi Kegiatan</label>
                        <p class="form-control-static"><?php echo e($data->deskripsi_kegiatan); ?></p>
                    </div>
                </div>                
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="">PIC</label>
                        <p class="form-control-static"><?php echo e($data->nama_pelaksana); ?></p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="">Tanggal Pelaksanaan</label>
                        <p class="form-control-static"><i class="mdi mdi-calendar"></i> <?php echo e(tanggal_indo($data->tgl_mulai) . ' s/d ' . tanggal_indo($data->tgl_selesai)); ?></p>
                    </div>
                </div>
                <div class="col-md-1">
                    <div class="form-group">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo e(rupiah($data->agr)); ?></p>
                    </div>
                </div>                
                <div class="col-md-2">
                    <div class="form-group">
        ...
        <?php if($data->status == 'approved'): ?>
            <div class="card-footer">
                <div class="float-right">                    
                    <a href="javascript:void(0)" onclick="window.open('<?php echo e(base_url('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/cetak_form_actbud?pdf=true')); ?>')" class="btn btn-primary btn-sm"><i class="mdi mdi-printer"></i> Cetak</a>
                </div>
            </div>
        <?php endif; ?>
        <!--<div class="card-footer">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped dataTable">
                    ...
                    <tbody id="tb-rincian-kegiatan">
                        <?php $__currentLoopData = $rincian_kegiatan->result(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo e(rupiah($item->total_anggaran)); ?></td>
                                <?php if($data->status == 'ongoing'): ?>
                                ...
                                <?php if($data->status == 'submitted' || $data->status == 'approved'): ?>
                                    <td>
                                        <ul style="list-style: none;padding-inline-start:0;" class="mb-0">
                                            <li>
                                                <span>Warek 1: </span>
                                                <span><?php echo e($item->catatan_wr_1); ?></span>
                                            </li>
                                            <li>
                                                <span>Warek 2: </span>
                                                <span><?php echo e($item->catatan_wr_2); ?></span>
                                            </li>
                                        </ul>
                                    </td>
                                <?php endif; ?>
                    ...
                    <tfoot>
                        ...
                        <td class="text-center"><?php echo e(rupiah($sisa->digunakan)); ?></td>
                        <?php if($data->status == 'ongoing'): ?>
                            <td></td>
                        <?php endif; ?>                        
                        <?php if($data->status == 'submitted' || $data->status == 'approved'): ?>
    ...
    <?php echo form_open('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/buat_pesan', array('id' => 'form-pesan', 'enctype' => 'multipart/form-data')); ?>
    ...
    <?php if($data->status == 'ongoing'): ?>
        ...
        <?php else: ?>
            <?php echo form_open('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/submit', array('id' => 'form-pesan', 'enctype' => 'multipart/form-data')); ?>
...
<?php if($data->status !== 'cancel' && $data->status !== 'approved'): ?>
<?php echo form_open('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/hapus-pesan'); ?>
...
<?php if($data->status == 'ongoing'): ?>
    <!--  Modal buat kegiatan -->
<?php echo form_open('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/buat-rincian-kegiatan'); ?>
...
<!-- Modal ubah actbud -->
<!--<?php echo form_open('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/ubah-actbud'); ?>
...
<?php echo form_open('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/upload-dokumen-pendukung', array('enctype' => 'multipart/form-data')); ?>
...
<?php echo form_open('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/batalkan-actbud'); ?>
...
<?php echo form_open('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/hapus-dokumen-pendukung'); ?>
...
<?php echo form_open('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/hapus-rincian-kegiatan'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/sponsorship/v_detail_actbud.blade.php ENDPATH**/ ?>