                    ...
                    <tbody>
                        <?php $__currentLoopData = $actbud; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="vertical-align: middle;"><?php echo e($item->kode_uraian); ?></td>
                                <td style="vertical-align: middle;"><?php echo e($item->kode_pencairan); ?></td>
                                <td style="vertical-align: middle;">
                                    <a href="javascript:void(0)" onclick="window.open('<?php echo e(base_url('app/' . $item->jenis_anggaran . '/pencairan/v_detail/' . encrypt($item->id_uraian) . '/actbud/' . encrypt($item->id))); ?>')"><?php echo e($item->nama_kegiatan); ?></a>
                                </td>
                                <td style="vertical-align: middle;"><?php echo e(tanggal_indo($item->tgl_mulai)); ?> s/d <?php echo e(tanggal_indo($item->tgl_selesai)); ?></td>
                                ...
                                <td style="vertical-align: middle;" class="text-center">
                                    <span class="badge badge-success"><i class="mdi mdi-check-bold"></i> Disetujui</span>                                    
                                </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/table/v_actbud_disetujui.blade.php ENDPATH**/ ?>