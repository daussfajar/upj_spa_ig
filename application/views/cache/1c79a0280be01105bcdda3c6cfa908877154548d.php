...
<div class="col-md-12">
    <div class="card-box">
        <div class="float-right">
            <a href="<?php echo e(base_url('app/sim-ig/data-pemberitahuan/set-sudah-dibaca-semua-pemberitahuan')); ?>" onclick="return confirm('Apakah anda yakin ingin set sudah dibaca pada semua notifikasi?')" class="btn btn-warning btn-sm"><i class="mdi mdi-check-bold"></i> Set Sudah Lihat Semua</a>
        </div>
        <br><br>
                        ...
                        <?php $__currentLoopData = $data['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr <?php echo $row['is_seen'] == 'no' ? 'style="background:#fcf8e3;"' : ''; ?>>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="<?php echo e(base_url('app/sim-ig/data-pemberitahuan/hapus_data/' . encrypt($row['id']))); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah anda yakin?')">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('ig.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/ig/users/pemberitahuan/index.blade.php ENDPATH**/ ?>