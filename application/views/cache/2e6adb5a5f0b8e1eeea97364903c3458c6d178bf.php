...
<a href="<?php echo e(base_url('app/sim-ig/hibah/status_pencairan')); ?>"><i class="mdi mdi-arrow-left"></i></a> Detail Kegiatan
...
<li class="breadcrumb-item"><a href="<?php echo e(base_url('app/sim-ig/hibah')); ?>"><i class="mdi mdi-briefcase-outline"></i> Hibah</a></li>
<li class="breadcrumb-item"><a href="<?php echo e($CI->uri->segment(4) == 'pencairan' ? base_url('app/sim-ig/hibah/pencairan') : base_url('app/sim-ig/hibah/status_pencairan')); ?>"><i class="mdi mdi-cash-register"></i> <?php echo e($CI->uri->segment(4) == 'pencairan' ? 'Pencairan' : 'Status Pencairan'); ?></a></li>
    ...
    <div class="card card-border card-teal">
        ...
        <?php if($data->status == 'approved'): ?>
            <div class="card-footer">
                <div class="float-right">                    
                    <a href="javascript:void(0)" onclick="window.open('<?php echo e(base_url('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/cetak_form_actbud?pdf=true')); ?>')" class="btn btn-primary btn-sm"><i class="mdi mdi-printer"></i></a>
                </div>
            </div>
        <?php endif; ?>
        <!--<div class="card-footer">
...
<?php if($data->status == 'ongoing'): ?>
    <!--  Modal buat kegiatan -->
<?php echo form_open('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/buat-rincian-kegiatan', array('class' => 'myForm')); ?>
...
<!-- Modal ubah actbud -->
<!--<?php echo form_open('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/ubah-actbud', array('class' => 'myForm')); ?>
...
<?php echo form_open('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/batalkan-actbud', array('class' => 'myForm')); ?>    
...
<?php echo form_open('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/hapus-dokumen-pendukung', array('class' => 'myForm')); ?>    
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('ig.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/ig/users/hibah/v_detail_actbud.blade.php ENDPATH**/ ?>