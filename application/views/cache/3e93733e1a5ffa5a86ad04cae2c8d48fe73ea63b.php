        ...
        <div class="card-box mt-2">
            <div class="row mb-3">                    
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <form action="<?php echo e(base_url('app/sim-ig/realisasi_anggaran')); ?>" method="GET" accept-charset="utf-8" autocomplete="off" class="myForm">
                        ...
                        <?php $__currentLoopData = $data['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <th style="vertical-align: middle;font-weight:bold;" title="Tanggal Pembuatan: <?php echo e($row['tanggal_pembuatan']); ?>">
                                    <a href="<?php echo e(base_url('app/sim-ig/realisasi_anggaran/history/v_detail/' . encrypt($row['id_uraian']) . '/actbud/' . encrypt($row['id']))); ?>" class="badge bg-primary p-2">
                                ...
                                <td class="text-center" style="vertical-align:middle;">
                                    <a href="<?php echo e(base_url('app/sim-ig/realisasi_anggaran/actbud/' . encrypt($row['id']) . '/' . encrypt($row['id_uraian']))); ?>" class="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('ig.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/ig/users/realisasi_anggaran/index.blade.php ENDPATH**/ ?>