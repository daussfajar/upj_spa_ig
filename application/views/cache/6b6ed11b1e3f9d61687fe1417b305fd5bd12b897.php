...
<?php $__env->startSection('page-title'); ?>
    <a href="<?php echo e(base_url('app/dashboard')); ?>" class=""><i class="mdi mdi-arrow-left"></i></a> Detail Pemberitahuan
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        <th>Pesan</th>
                        <td>:</td>
                        <td><?php echo e($getNotif->user_name); ?> <?php echo e($getNotif->message == '' ? '-' : $getNotif->message); ?></td>
                    </tr>
                    <tr>
                        <th>Waktu</th>
                        <td>:</td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/pemberitahuan/detail.blade.php ENDPATH**/ ?>