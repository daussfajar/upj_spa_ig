...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Modal Edit Karyawan -->
    <?php echo form_open('', array('id' => 'form-edit-karyawan', 'class' => 'myForm')); ?>    
    ...
    <?php echo form_open('app/master-data/karyawan/tambah_karyawan', array('id' => 'form-tambah-karyawan', 'class' => 'myForm')); ?>    
    ...
    <?php echo form_open('app/master-data/karyawan/ubahpass', array('id' => 'form-ubahpass-karyawan', 'class' => 'myForm')); ?>
    ...
    <?php echo form_open('', array('id' => 'form-hapus-karyawan', 'class' => 'myForm')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('ig.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/ig/admin/master_data/karyawan.blade.php ENDPATH**/ ?>