...
<?php $__env->startSection('content'); ?>
	...
	<div class="col-md-12">
		...
		<?php if($data['sign'] == $kode_unit && ($data['st_hrd'] == "" && $data['st_umum'] == "" && $data['st_ict'] == "" 
        && $data['st_bkal'] == "" && $data['st_p2m'] == "")): ?>
        <?php echo form_open('app/sim-spa/approval/pre-approval/kirim-persetujuan/' . encrypt($id_actbud), array('id' => 'form-persetujuan', 'class' => 'myForm')); ?>	
        <div class="card">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('spa.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/spa/approval/detail/pre-approval.blade.php ENDPATH**/ ?>