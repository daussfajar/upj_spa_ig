...
<div class="left-side-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li class="<?= menu_active(2, 'hibah', 'mm-active') ?><?= menu_active(2, 'sponsorship', 'mm-active') ?>">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li class="<?= menu_active(2, 'sponsorship', 'mm-active') ?>">
                            <a href="<?php echo e(base_url('app/kredit_saldo')); ?>" class="waves-effect waves-light <?= menu_active(2, 'sponsorship', 'active') ?>">                                
    ...
    <!-- Sidebar -left -->
</div><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/layouts/user_sidebar_menu.blade.php ENDPATH**/ ?>