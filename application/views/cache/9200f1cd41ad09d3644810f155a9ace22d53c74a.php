...
<?php $__env->startSection('title', 'Hibah'); ?>

<?php $__env->startSection('page-title'); ?>
<i class="mdi mdi-briefcase-outline"></i> Data Hibah
...
<li class="breadcrumb-item active"><a href="javascript: void(0);"><i class="mdi mdi-briefcase-outline"></i> Hibah</a>
</li>
<?php $__env->stopSection(); ?>
...
<div class="col-md-12">
	<div class="card-box mt-2">
		<div class="row mb-3">
			<div class="col-md-8 col-sm-8 col-xs-12">
				...
				<div class="float-right">
					<a href="javascript:void(0)" id="btn-upload" class="btn btn-info btn-sm"><i
							class="mdi mdi-upload"></i> Upload</a>					
				</div>
				<?php endif; ?>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-12">
				...
				<div class="float-right">
					<form action="<?php echo e(base_url('app/hibah')); ?>" method="GET" accept-charset="utf-8" autocomplete="off">
						<div class="input-group">
							<input type="search" id="q" value="<?php echo e(!empty($_GET['q']) ? $_GET['q'] : ''); ?>" name="q"
								class="form-control" placeholder="Cari data...">
							<span class="input-group-prepend">
								<button type="submit" class="btn waves-effect waves-light btn-primary btn-sm"><i
		...
		<?php else: ?>
		<div class="alert alert-info">
			<p class="mb-0"><i class="mdi mdi-magnify"></i> Hasil pencarian dari:
				"<b><?php echo e($CI->input->get('q', true)); ?></b>"</p>
		</div>
		<?php endif; ?>
		<?php endif; ?>
				...
				<tbody id="tb-hibah">
					...
					<tr>
						...
						<th style="vertical-align: middle;"><a
								href="<?php echo e(base_url('app/hibah/v_detail/' . encrypt($row['id']))); ?>"><?php echo e($row['kode_uraian']); ?></a>
						</th>
						<th style="vertical-align: middle;"><?php echo e($row['kode_pencairan']); ?></th>
						<td style="vertical-align: middle;"><?php echo e($row['nama_hibah_sponsorship']); ?></td>
						...
						<td style="vertical-align: middle;">
							<?php echo $row['nama_lengkap'] == '' ? '<span class="badge bg-warning">Belum ditentukan</span>' : $row['nama_lengkap']; ?>
						...
						<td class="text-center" style="vertical-align: middle;">
							...
							<?php elseif($row['finalisasi'] == 'Y'): ?>
								<?php
									$getSum = $CI->db->query(sprintf("SELECT SUM(a.agr) digunakan FROM 
									...
									ig_tbl_in_out b WHERE b.kode_uraian_in = '%s' 
									AND b.disetujui = 'Y'", $row['kode_uraian']))->row();
									$getSumOut = $CI->db->query(sprintf("SELECT SUM(b.nominal) saldo_keluar FROM 
									ig_tbl_in_out b WHERE b.kode_uraian_out = '%s' 
									AND b.disetujui = 'Y'", $row['kode_uraian']))->row();									
									echo rupiah($row['total_agr'] - $getSum->digunakan + $getSumIn->saldo_masuk - $getSumOut->saldo_keluar);
								?>		
							<?php endif; ?>
						</td>
					</tr>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<a href="<?= base_url('app-data/template-excel/Template upload uraian (IG  & Sponsorship).xlsx') ?>"
					download="Template upload uraian (IG  & Sponsorship)" class="btn btn-success btn-sm"><i
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-primary btn-sm waves-effect waves-light">Upload <i
...
<?php echo form_open('', array('id' => 'form-batalkan')); ?>
...
<!--  Modal edit -->
<?php echo form_open('', array('id' => 'form-ubah')); ?>
...
<?php echo form_open('', array('id' => 'form-finalisasi')); ?>
...
<?php echo form_open('', array('id' => 'form-set_pic')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">						
						...
						<p class="col-lg-8 form-control-static kode_uraian" style="font-weight: bold;"></p>
						<label class="col-lg-4 control-label" for="">Kode Pencairan</label>
						<p class="col-lg-8 form-control-static kode_pencairan" style="font-weight: bold;"></p>
						<label class="col-lg-4 control-label" for="">Nama Hibah/Sponsorship</label>
						<p class="col-lg-8 form-control-static nama_hibah_sponsorship" style="font-weight: bold;"></p>
						<label class="col-lg-2 control-label" for="address2">PIC *</label>
						<div class="col-lg-10">
							<select name="pic" id="pic" class="form-control select2" style="width:100%;" required>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/hibah/index.blade.php ENDPATH**/ ?>