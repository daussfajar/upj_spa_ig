		...
		<div class="row mb-3">
			<div class="col-md-8 col-sm-8 col-xs-12">
				...
				<div class="float-right">
					<a href="javascript:void(0)" id="btn-upload" class="btn btn-info btn-sm">
                        <i class="mdi mdi-upload"></i> Upload
                    </a>
                    <a href="javascript:void(0)" class="btn btn-secondary btn-sm"><i class="mdi mdi-filter"></i> Filter</a>
				</div>
				<?php endif; ?>
			</div>
				...
				<tbody id="tb-hibah">
					...
					<tr>
						...
						<th style="vertical-align: middle;">
                            <a href="<?php echo e(base_url('app/hibah/v_detail/' . encrypt($row['id']))); ?>" class="badge bg-purple">
						...
						<td style="vertical-align: middle;">
							<span class="" style="font-size: 14px;">
                                <?php echo $row['nama_lengkap'] == '' ? '<span class="badge bg-warning">Belum ditentukan</span>' : $row['nama_lengkap'] . ' ('.$row['pic'].')'; ?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group mt-3">
					<label for="">Unit/Prodi</label><br>
					<select name="unit_prodi" id="unit_prodi" style="width: 100%;" class="form-control pl-0 select2" required>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hibah_upj_dev\application\views/users/hibah/index.blade.php ENDPATH**/ ?>