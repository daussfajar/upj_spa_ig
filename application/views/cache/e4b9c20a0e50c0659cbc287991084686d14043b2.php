                        ...
                        <?php $__currentLoopData = $actbud; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="vertical-align: middle;">
                                    <a href="javascript:void(0)" onclick="window.open('<?php echo e(base_url('app/' . $item->jenis_anggaran . '/pencairan/v_detail/' . encrypt($item->id_uraian) . '/actbud/' . encrypt($item->id))); ?>', 'MsgWindow', 'width=800,height=800')"><?php echo $item->nama_kegiatan; ?></a>
                                </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hibah_upj\application\views/users/table/v_actbud_ditolak.blade.php ENDPATH**/ ?>