        ...
        <div class="card-box mt-2">
            <div class="row mb-3">                    
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <form action="<?php echo e(base_url('app/sim-ig/sponsorship/pencairan')); ?>" class="myForm" method="GET" accept-charset="utf-8" autocomplete="off">                        
                        ...
                        ?>
                            <?php $__currentLoopData = $data['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <!--<th style="vertical-align: middle;"><a href="<?php echo e(base_url('app/sim-ig/hibah/pencairan/detail_hibah/' . encrypt($row['id']))); ?>"><?php echo e($row['kode_uraian']); ?></a></th>-->
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <a href="<?php echo e(base_url('app/sim-ig/sponsorship/pencairan/v_detail/' . encrypt($row['id']) . '/buat_pencairan')); ?>" class="badge bg-primary btn-sm p-2">Buat Pencairan <i class="mdi mdi-arrow-right"></i></a>
                                    </td>
                                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('ig.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/ig/users/sponsorship/v_data_pencairan.blade.php ENDPATH**/ ?>