...
<?php $__env->startSection('title', 'Sponsorship - Detail Kegiatan'); ?>

<?php $__env->startSection('page-title'); ?>
    <a href="<?php echo e(base_url('app/sponsorship/pencairan')); ?>"><i class="mdi mdi-arrow-left"></i></a> Pencairan
...
<li class="breadcrumb-item active"><a href="<?php echo e(base_url('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5))); ?>"><b><i class="mdi mdi-file-document-outline"></i> <?php echo e($data->kode_uraian); ?></a></b></li>
<?php $__env->stopSection(); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">                      
            ...
            <div class="float-right mb-3">
                <a href="<?php echo e(base_url('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/buat_pencairan')); ?>" class="btn btn-success btn-sm">+ Buat Pencairan</a>
            </div>  
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/sponsorship/v_detail_pencairan.blade.php ENDPATH**/ ?>