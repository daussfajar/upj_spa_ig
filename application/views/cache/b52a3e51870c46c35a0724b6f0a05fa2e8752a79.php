...
<?php $__env->startSection('title'); ?>
    Detail Approval Actbud Keuangan
...
<div class="col-lg-12">
    <?php echo form_open('app/sim-spa/approval/keuangan/kirim-persetujuan/' . encrypt($kd_act), array('class' => 'myForm')); ?>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="st_keuangan" id="st_keuangan_1" value="Disetujui" checked>
                            <label class="form-check-label" for="st_keuangan_1">
                                Disetujui
                            </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="st_keuangan" id="st_keuangan_2" value="Ditolak">
                            <label class="form-check-label" for="st_keuangan_2">
                                Ditolak
                            </label>
                        </div>
                    </div>
...
<div class="col-lg-12">
    <?php echo form_open('app/sim-spa/approval/keuangan/kirim-pesan/' . encrypt($kd_act), array('class' => 'myForm')); ?>
...
<script>
    $(document).ready(function(){
        $('#tbody-table-detail-biaya').on('click', '.btn-beri-catatan', function(){
            var id = $(this).data('id');
            var catatan = $(this).data('catatan-keuangan');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('spa.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/spa/approval/detail-approval-keuangan.blade.php ENDPATH**/ ?>