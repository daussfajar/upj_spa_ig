...
<li class="breadcrumb-item active">Presiden</li>
<?php $__env->stopSection(); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive my-4">
                <table class="table table-striped table-bordered table-hover" id="table-approval-presiden" width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('app/sim-spa/approval/presiden/detail/') . $value['kd_act']; ?> ">Lihat</a> </td>
                                    </tr>
                        <?php
                                }
                            }
...
<script>
    $(document).ready(function(){
        $("#table-approval-presiden").DataTable({
            oLanguage: {
                sProcessing: "Loading..."
            },
            lengthMenu: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('spa.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/spa/approval/approval-presiden.blade.php ENDPATH**/ ?>