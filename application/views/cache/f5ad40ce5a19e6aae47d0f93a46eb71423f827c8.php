...
<body class="authentication-bg">
    <div class="home-btn d-none d-sm-block">
        <a href="<?php echo e(base_url()); ?>"><i class="mdi mdi-home h2"></i></a>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-6 text-center">
                    ...
                    <div class="wrapper-page">
                        <img src="<?php echo e(base_url('assets/images/gif/animate-search-color.gif')); ?>" alt="" height="120">
                        <h2 class="text-uppercase text-danger">404 Error</h2>
                        <p class="text-muted mb-2">
                            Maaf! sepertinya halaman yang anda cari tidak ditemukan.
                        </p>

                        <a class="btn btn-success btn-sm waves-effect waves-light mt-4" href="<?php echo e(base_url()); ?>">
                            Kembali
                        </a>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\hibah_upj_dev\application\views/404.blade.php ENDPATH**/ ?>