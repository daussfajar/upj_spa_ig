...
<?php $__env->startSection('page-title'); ?>
    <a href="<?php echo e(base_url('app/sponsorship')); ?>"><i class="mdi mdi-arrow-left"></i></a> Create Sponsorship
...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12">
        <div class="card-box">
            ...
            <?php echo form_open('app/sponsorship/buat_kegiatan/submit', array('id' => 'wizard-validation-form')); ?>
                ...
                <div>
                    ...
                    <section>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label " for="surname2"> Base Line *</label>
                            <div class="col-lg-10">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/sponsorship/tambah_data.blade.php ENDPATH**/ ?>