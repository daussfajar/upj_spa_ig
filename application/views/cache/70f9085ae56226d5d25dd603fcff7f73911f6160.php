    ...
    <div class="card-box mt-2">
        <div class="row mb-3">                    
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <form action="<?php echo e(base_url('app/sim-ig/riwayat_approval')); ?>" method="GET" accept-charset="utf-8" autocomplete="off" class="myForm">
                        ...
                        ?>
                            <?php $__currentLoopData = $data['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle" class="text-center">
                                        <a href="<?php echo e(base_url('app/sim-ig/riwayat_approval/v_detail/' . encrypt($row['id']))); ?>" class="btn btn-primary col-12 btn-xs">Lihat <i class="mdi mdi-arrow-right"></i></a>
                                        <?php if($row['st_warek_2'] == 'Y'): ?>
                                            <a href="javascript:void(0)" onclick="window.open('<?php echo e(base_url('app/sim-ig/hibah/pencairan/v_detail/'.encrypt($row['id_uraian']).'/actbud/'.encrypt($row['id']).'/cetak_form_actbud?pdf=true')); ?>', 'MsgWindow', 'width=800,height=800')" class="btn btn-info col-12 btn-xs mt-1"><i class="mdi mdi-printer"></i> Cetak</a>
                                        <?php endif; ?>                                        
                                    </td>
                                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('ig.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/ig/users/history_approval/index.blade.php ENDPATH**/ ?>