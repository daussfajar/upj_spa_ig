            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                        <label for="" class="col-4">Pilih Kredit Saldo</label>
                        <select name="jenis_kredit" id="jenis_kredit" class="form-control select2 col-7">
                            <option value="">Pilih Jenis Kredit</option>
                            <option value="in">Saldo Masuk</option>
                            <option value="out">Saldo Keluar</option>
                        </select>
                    </div>
                    <div class="form-group row">
                        <label for="" class="col-4">Pilih Kegiatan</label>
                        <select name="kegiatan" id="kegiatan" class="form-control select2 col-7">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hibah_upj\application\views/users/kredit_saldo/buat_kredit.blade.php ENDPATH**/ ?>