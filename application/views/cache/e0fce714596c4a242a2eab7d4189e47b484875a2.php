...
<a href="<?php echo e(base_url('app/approval')); ?>" class=""><i class="mdi mdi-arrow-left"></i></a> <i class="mdi mdi-file-document-outline"></i> Detail Actbud
		...
		<div class="row">
			<div class="col-md-3">
				<div class="form-group">
					...
					<p class="form-control-static"><b><?php echo e($data->kode_uraian); ?></b></p>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
			...
			<div class="col-md-3">
				<div class="form-group">
					<label for="">PIC</label>
					<p class="form-control-static"><?php echo e($data->pic); ?></p>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					<label for="">Pelaksana</label>
					<p class="form-control-static"><?php echo e($data->pelaksana); ?></p>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
	...
	<div class="card-box">
		<ul class="nav nav-tabs tabs-bordered nav-justified" role="tablist">
			<li class="nav-item">
				<a class="nav-link active" id="detail-biaya-tab" data-toggle="tab" href="#detail-biaya" role="tab"
					...
					<span class="d-none d-sm-block">Detail Biaya</span>
				</a>
			</li>
			<li class="nav-item">
		...
		<div class="tab-content">
					...
					<table class="table table-striped table-bordered dataTable">
						...
						<tbody id="tb-biaya">
							...
							<tr>
								...
								<td style="vertical-align: middle"><?php echo e($item->nama_kegiatan); ?></td>
			...
			<div class="tab-pane" id="pesan" role="tabpanel" aria-labelledby="pesan-tab">
				<?php echo form_open('app/approval/v_detail/' . $CI->uri->segment(4) . '/buat_pesan', array('id' =>
							...
							<tr>
								...
								<td class="text-center">
									<a href="<?php echo e(base_url('app-data/dokumen-pendukung/' . $row->nama_file)); ?>"
										class="btn btn-info btn-sm" download="<?php echo e($pecah_nama[1]); ?>" title="Download">
...
<?php echo form_open('app/approval/v_detail/' . $CI->uri->segment(4) . '/hapus_pesan'); ?>
...
<?php if($kode_jabatan == 3 || $kode_jabatan == 0): ?>
<?php echo form_open('app/approval/v_detail/' . $CI->uri->segment(4) . '/buat_catatan_wr_1'); ?>
...
<?php if($kode_jabatan == 4 || $kode_jabatan == 0): ?>
<?php echo form_open('app/approval/v_detail/' . $CI->uri->segment(4) . '/buat_catatan_wr_2'); ?>
...
<div class="col-md-12">
	<?php echo form_open('app/approval/v_detail/' . $CI->uri->segment(4) . '/submit_actbud', array('id' => 'form-persetujuan')); ?>
			...
			<div class="form-group row">
				...
				<div class="col-md-9">
					<div class="radio radio-success form-check-inline">
						...
						<label for="chk-setuju"> Setuju </label>
					</div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/approval/v_detail.blade.php ENDPATH**/ ?>