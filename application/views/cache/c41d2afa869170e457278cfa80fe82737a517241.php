    ...
    <div class="card card-border card-teal">
        ...
        <?php if($data->status == 'approved'): ?>
            <div class="card-footer">
                <div class="float-right">                    
                    <a href="javascript:void(0)" onclick="window.open('<?php echo e(base_url('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/cetak_form_actbud?pdf=true')); ?>')" class="btn btn-primary btn-sm"><i class="mdi mdi-printer"></i></a>
                </div>
            </div>
        <?php endif; ?>
        <!--<div class="card-footer">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hibah_upj\application\views/users/sponsorship/v_detail_actbud.blade.php ENDPATH**/ ?>