...
<?php echo form_open('app/approval/v_detail/' . $CI->uri->segment(4) . '/hapus_pesan', array('class' => 'myForm')); ?>
...
<?php if($kode_jabatan == 3 || $kode_jabatan == 0): ?>
<?php echo form_open('app/approval/v_detail/' . $CI->uri->segment(4) . '/buat_catatan_wr_1', array('class' => 'myForm')); ?>
...
<?php if($kode_jabatan == 4 || $kode_jabatan == 0): ?>
<?php echo form_open('app/approval/v_detail/' . $CI->uri->segment(4) . '/buat_catatan_wr_2', array('class' => 'myForm')); ?>
...
<div class="col-md-12">
	<?php echo form_open('app/approval/v_detail/' . $CI->uri->segment(4) . '/submit_actbud', array('id' => 'form-persetujuan', 'class' => 'myForm')); ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/users/approval/v_detail.blade.php ENDPATH**/ ?>