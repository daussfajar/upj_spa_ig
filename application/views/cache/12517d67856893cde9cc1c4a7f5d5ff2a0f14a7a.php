...
<?php $__env->startSection('title'); ?>
    <?= MOD2 ?> Pencairan RKAT - Input Petty Cash - <?php echo e($data['uraian']); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-title'); ?>
    <a href="<?php echo e(base_url('app/sim-spa/pencairan-rkat/input-petty-cash')); ?>"><i class="mdi mdi-arrow-left"></i></a> Input Petty Cash
<?php $__env->stopSection(); ?>
...
<li class="breadcrumb-item"><a href="javascript: void(0);">Input Petty Cash</a></li>
<li class="breadcrumb-item active"><a href="javascript: void(0);"><?php echo e($data['kode_pencairan']); ?></a></li>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <?php if($sisa_agr > 0){ ?>
    <?php echo form_open(base_url('app/sim-spa/pencairan-rkat/input-petty-cash/' . $id), array('class' => 'myForm')); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-footer bg-transparent">
                <button type="<?= $sisa_agr > 0 ? 'submit' : 'button' ?>" class="btn btn-primary btn-block" style="font-weight:bold;"<?= $data['sisa_anggaran'] == 0 ? ' disabled title="Maaf anggaran sudah habis"' : '' ?><?= $sisa_agr > 0 ? '' : ' disabled' ?>><i class="mdi mdi-file-plus"></i> Input Petty Cash</button>
            </div>
        </div>
    </div>
    <?php if($sisa_agr > 0){ ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('spa.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/spa/pencairan_rkat/petty_cash/v_proses_input_petty_cash.blade.php ENDPATH**/ ?>