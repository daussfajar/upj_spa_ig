...
<div class="left-side-menu">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li class="<?= menu_active(3, 'dashboard', 'mm-active') ?>">
                    <a href="<?php echo e(base_url('app/sim-ig/dashboard')); ?>" class="waves-effect waves-light <?= menu_active(3, 'dashboard', 'active') ?>">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li class="<?= menu_active(3, 'hibah', 'mm-active') ?>">
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <?php if($unit == 'Bagian Keuangan' || $jabatan == 0 || $jabatan == 22 || $jabatan == 6): ?>
                                    <li class="<?= (($CI->uri->segment(3) == 'hibah' && $CI->uri->segment(3) == 'buat_kegiatan') || ($CI->uri->segment(3) == 'hibah' && is_numeric($CI->uri->segment(4)))) ? 'mm-active' : '' ?>">
                                        <a href="<?php echo e(base_url('app/sim-ig/hibah')); ?>" class="<?= menu_active(4, 'buat_kegiatan', 'active') ?>">Kegiatan</a>
                                    </li>
                                <?php endif; ?>                       
                        ...
                        <?php if($unit == 'Bagian Keuangan' || $jabatan == 0 || $jabatan == 22 || $jabatan == 6): ?>
                            <!--<li class="<?= menu_active(3, 'kredit_saldo', 'mm-active') ?>">
                                <a href="<?php echo e(base_url('app/sim-ig/kredit_saldo')); ?>" class="waves-effect waves-light <?= menu_active(3, 'kredit_saldo', 'active') ?>"> 
                                    <span>  Debet/Kredit Saldo  </span>                                
                                </a>
                            </li>-->
                            <li class="<?= menu_active(3, 'kredit_saldo', 'mm-active') ?>">
                                <a href="<?php echo e(base_url('app/sim-ig/pengalihan-anggaran')); ?>" class="waves-effect waves-light <?= menu_active(3, 'kredit_saldo', 'active') ?>"> 
                        ...
                        <li class="<?= menu_active(3, 'realisasi_anggaran', 'mm-active') ?>">
                            <a href="<?php echo e(base_url('app/sim-ig/realisasi_anggaran')); ?>" class="waves-effect waves-light <?= menu_active(3, 'realisasi_anggaran', 'active') ?>">                                
                ...
                <?php if($jabatan != 7): ?>
                    <li class="<?= menu_active(3, 'approval', 'mm-active') ?>">
                        <a href="<?php echo e(base_url('app/sim-ig/approval')); ?>" class="waves-effect waves-light <?= menu_active(3, 'approval', 'active') ?>">
                            <i class="mdi mdi-clipboard-file-outline"></i>                                    
                            <span>  Approval  </span>
                        </a>                              
                    </li>
                    <li class="<?= menu_active(3, 'riwayat_approval', 'mm-active') ?>">
                        <a href="<?php echo e(base_url('app/sim-ig/riwayat_approval')); ?>" class="waves-effect waves-light <?= menu_active(3, 'riwayat_approval', 'active') ?>">
                ...
                <?php if($jabatan == 0): ?>
                    <li class="<?= menu_active(3, 'master-data', 'mm-active') ?>">
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li>
                                <a href="<?php echo e(base_url('app/sim-ig/master-data/karyawan')); ?>" class="waves-effect waves-light <?= menu_active(4, 'karyawan', 'active') ?>">
                                    <span>  Karyawan  </span>                                 
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(base_url('app/sim-ig/master-data/unit')); ?>" class="waves-effect waves-light <?= menu_active(4, 'unit', 'active') ?>">
                                    <span>  Unit/Bagian  </span>                                 
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(base_url('app/sim-ig/master-data/jabatan')); ?>" class="waves-effect waves-light <?= menu_active(4, 'jabatan', 'active') ?>">
                                    <span>  Jabatan  </span>                                 
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="<?= menu_active(3, 'pengaturan', 'mm-active') ?>">
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li>
                                <a href="<?php echo e(base_url('app/sim-ig/pengaturan/umum')); ?>" class="waves-effect waves-light <?= menu_active(4, 'umum', 'active') ?>">
                                    <span>  Umum  </span>                                 
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(base_url('app/sim-ig/pengaturan/login_logs')); ?>" class="waves-effect waves-light <?= menu_active(4, 'login_logs', 'active') ?>">
                                    <span>  Login Logs  </span>                                 
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(base_url('app/sim-ig/pengaturan/banned_ip')); ?>" class="waves-effect waves-light <?= menu_active(4, 'banned_ip', 'active') ?>">
                                    <span>  Banned IP  </span>                                 
                                </a>
                            </li>
                        </ul>
    ...
    <!-- Sidebar -left -->
</div><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/ig/layouts/user_sidebar_menu.blade.php ENDPATH**/ ?>