                ...
                <table class="table table-bordered">
                    <thead class="bg-purple text-white">
                        <tr>
                            ...
                            <th class="text-center" style="vertical-align: middle">Kode Sub Aktivitas</th>
                            <th class="text-center" style="vertical-align: middle">Indikator Kerja Umum</th>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $sheet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                ...
                                $kode_sub_aktivitas = $row['K'];
                                $indikator_kerja_umum = $row['L'];
                                $tahun = $row['M'];
                                $total_anggaran = $row['N'];
                                $numrow++;
                            ?>
                            ...
                            <?php if($numrow > 1): ?>
                                ...
                                <input type="hidden" name="kode_sub_aktivitas[]" value="<?php echo e($kode_sub_aktivitas); ?>">
                                <input type="hidden" name="indikator_kerja_umum[]" value="<?php echo e($indikator_kerja_umum); ?>">
                                ...
                                <?php
                                    ...
                                    $td_kode_sub_aktivitas = empty($kode_sub_aktivitas) ? " style='background:#E07171;'" : "style='vertical-align:middle;'";
                                    $td_indikator_kerja_umum = empty($indikator_kerja_umum) ? " style='background:#E07171;'" : "style='vertical-align:middle;'";
                                    ...
                                    $kode_pencairan == "" || $tahun == "" || $total_anggaran == "" || $kode_sub_aktivitas == "" 
                                    || $indikator_kerja_umum == ""){
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" <?php echo $td_kode_sub_aktivitas; ?>>
                                        <?php echo e($kode_sub_aktivitas); ?>

                                    </td>
                                    <td class="text-center" <?php echo $td_indikator_kerja_umum; ?>>
                                        <?php echo e($indikator_kerja_umum); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hibah_upj\application\views/users/hibah/preview_upload_hibah.blade.php ENDPATH**/ ?>