			...
			<?php $__currentLoopData = array_slice($getNotif, 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<a href="<?php echo e(base_url('app/detail-pemberitahuan/' . $item->id)); ?>" class="dropdown-item notify-item <?php echo e($item->is_seen == 'no' ? 'bg-unseen_notif' : ''); ?>">
					...
					<p class="notify-details"><?php echo e($item->title); ?>
						...
						<small class="text-muted"><b><?php echo e($item->user_name); ?></b> <?php echo $item->message .'<span style="font-size:11px">'.tanggal_indo($tanggal).', '.$jam.'</span>'; ?></small>
					</p>
				</a>
...
<?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/layouts/user_notification.blade.php ENDPATH**/ ?>