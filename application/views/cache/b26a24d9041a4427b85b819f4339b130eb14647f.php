                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $data_logs['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="<?php echo e($item['nama_user'] == "" ? 'bg-danger text-white' : ''); ?>">
                                    ...
                                    <td><?php echo e($item['nama_user'] == "" ? 'Unknown user' : $item['nama_user']); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hibah_upj\application\views/admin/data_login_logs.blade.php ENDPATH**/ ?>