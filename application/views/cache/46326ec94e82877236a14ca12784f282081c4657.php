        ...
        <li class="step <?php 
            ...
            <?php if($data->st_kabag !== ''): ?>
                ...
                <?php switch($data->st_kabag):
                    case ('Y'): ?>
                        Disetujui <br> <i class="mdi mdi-calendar-check"></i> <?php echo e(substr($data->stamp_kabag, 0, 19)); ?>
        ...
        ?>">
            ...
            <?php if($data->st_sign !== ''): ?>
                ...
                <?php switch($data->st_sign):
                    case ('Y'): ?>
                        <?php echo $data->sign != "" ? 'Disetujui <br><i class="mdi mdi-calendar-check"></i> ' . substr($data->stamp_sign, 0, 19) : '(Tidak ada Pre-Approval)'; ?>
        ...
        <li class="step <?php 
            ...
            <?php if($data->st_keu !== ''): ?>
                ...
                <?php switch($data->st_keu):
                    case ('Y'): ?>
                        Disetujui <br><i class="mdi mdi-calendar-check"></i> <?php echo e(substr($data->stamp_keu, 0, 19)); ?>
        ...
        <li class="step <?php 
            ...
            <?php if($data->st_warek_1 !== ''): ?>
                ...
                <?php switch($data->st_warek_1):
                    case ('Y'): ?>
                        Disetujui <br><i class="mdi mdi-calendar-check"></i> <?php echo e(substr($data->stamp_warek1, 0, 19)); ?>
        ...
        <li class="step <?php 
            ...
            <?php if($data->st_warek_2 !== ''): ?>
                ...
                <?php switch($data->st_warek_2):
                    case ('Y'): ?>
                        Disetujui <br><i class="mdi mdi-calendar-check"></i> <?php echo e(substr($data->stamp_warek2, 0, 19)); ?>
...
<!-- /.modal --><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/hibah/tracker_status_actbud.blade.php ENDPATH**/ ?>