...
<li class="breadcrumb-item active"><a href="<?php echo e(base_url('app/sponsorship/pencairan')); ?>"><i class="mdi mdi-cash-register"></i> Pencairan</a></li>
<li class="breadcrumb-item"><a href="<?php echo e(base_url('app/sponsorship/pencairan')); ?>"><b><i class="mdi mdi-file-document-outline"></i> <?php echo e($data->kode_uraian); ?></a></b></li>
...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12">
        <div class="card-box">
            ...
            <?php echo form_open('app/sponsorship/pencairan/v_detail/' . $CI->uri->segment(5) . '/buat_pencairan/create?id=' . encrypt($data->id), array('id' => 'wizard-validation-form')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/sponsorship/buat_pencairan.blade.php ENDPATH**/ ?>