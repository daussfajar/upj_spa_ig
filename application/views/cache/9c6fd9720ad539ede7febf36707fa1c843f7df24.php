...
<div class="col-md-12">
    ...
    <?php echo form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/buat_pesan', array('id' => 'form-pesan', 'enctype' => 'multipart/form-data', 'class' => 'myForm')); ?>
    ...
    <?php if($data->status == 'ongoing'): ?>
        ...
        <?php else: ?>
            <?php echo form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/submit', array('id' => 'form-submit-actbud', 'enctype' => 'multipart/form-data')); ?>
...
<?php if($data->status !== 'cancel' && $data->status !== 'approved'): ?>
<?php echo form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/hapus-pesan', array('class' => 'myForm')); ?>
...
<?php if($data->status == 'ongoing'): ?>
    <!--  Modal buat kegiatan -->
<?php echo form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/buat-rincian-kegiatan', array('class' => 'myForm')); ?>
...
<!-- Modal ubah actbud -->
<!--<?php echo form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/ubah-actbud', array('class' => 'myForm')); ?>
...
<?php echo form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/upload-dokumen-pendukung', array('enctype' => 'multipart/form-data', 'class' => 'myForm')); ?>    
...
<?php echo form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/batalkan-actbud', array('class' => 'myForm')); ?>    
...
<?php echo form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/hapus-dokumen-pendukung', array('class' => 'myForm')); ?>    
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/users/hibah/v_detail_actbud.blade.php ENDPATH**/ ?>