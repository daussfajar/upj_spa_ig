...
<div class="col-lg-12">
    <?php echo form_open($urlKirimPersetujuan, array('class' => 'myForm')); ?>
...
<div class="col-lg-12">
    <?php echo form_open('app/sim-spa/approval/dekan/kirim-pesan/' . encrypt($kd_act), array('class' => 'myForm')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('spa.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/spa/approval/detail-approval-dekan.blade.php ENDPATH**/ ?>