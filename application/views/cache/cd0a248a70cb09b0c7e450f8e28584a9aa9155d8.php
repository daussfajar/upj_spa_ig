...
<?php $__env->startSection('content'); ?>
                            ...
                            <?php $__currentLoopData = $data['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <th style="vertical-align: middle;">
                                        <a href="<?php echo e(base_url('app/sponsorship/v_detail/'.encrypt($row['id']))); ?>"><?php echo e($row['kode_uraian']); ?></a>
                                    </th>
                                    ...
                                    <td style="vertical-align: middle;"><?php echo e($row['nama_lengkap']); ?> (<?php echo e($row['nama_unit']); ?>)</td>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        ...
                                        <?php elseif($row['finalisasi'] == 'Y'): ?>
                                            <?php
                                                $getSum = $CI->db->query(sprintf("SELECT SUM(a.agr) digunakan FROM ig_tbl_actbud a WHERE a.id_uraian = '%u' AND a.status_act = 'send' AND (a.status != 'cancel')", $row['id']))->row();
    ...
    <?php echo form_open('app/sponsorship/preview_upload', array('enctype' => 'multipart/form-data')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/sponsorship/index.blade.php ENDPATH**/ ?>