...
<body class="left-side-menu-light">
    ...
    <div id="wrapper">
        ...
        <!-- ========== Left Sidebar Start ========== -->
        <?php echo $__env->make('spa.layouts.sidebar_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Left Sidebar End -->
...
</html><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/spa/layouts/main.blade.php ENDPATH**/ ?>