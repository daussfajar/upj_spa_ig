...
<a href="<?php echo e(base_url('app/sim-ig/sponsorship/status_pencairan')); ?>"><i class="mdi mdi-arrow-left"></i></a> Detail Kegiatan
...
<li class="breadcrumb-item"><a href="<?php echo e(base_url('app/sim-ig/sponsorship')); ?>"><i class="mdi mdi-briefcase-outline"></i> Sponsorship</a></li>
<li class="breadcrumb-item"><a href="<?php echo e($CI->uri->segment(4) == 'pencairan' ? base_url('app/sim-ig/sponsorship/pencairan') : base_url('app/sim-ig/sponsorship/status_pencairan')); ?>"><i class="mdi mdi-cash-register"></i> <?php echo e($CI->uri->segment(4) == 'pencairan' ? 'Pencairan' : 'Status Pencairan'); ?></a></li>
<li class="breadcrumb-item"><a href="javascript:void(0)"><b><i class="mdi mdi-file-document-outline"></i> <?php echo e($data->kode_uraian); ?></a></b></li>
...
<?php if($data->status !== 'ongoing'): ?>
    <div class="col-md-12">
        ...
        <?php echo $__env->make('ig.users.hibah.tracker_status_actbud', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>        
<?php endif; ?>
...
<div class="col-md-12">
    <div class="card card-border card-teal">
        ...
        <?php if($data->status == 'approved'): ?>
            <div class="card-footer">
                <div class="float-right">                    
                    <a href="javascript:void(0)" onclick="window.open('<?php echo e(base_url('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/cetak_form_actbud?pdf=true')); ?>')" class="btn btn-primary btn-sm"><i class="mdi mdi-printer"></i></a>
                </div>
            </div>
        <?php endif; ?>
        <!--<div class="card-footer">
    ...
    <?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/buat_pesan', array('id' => 'form-pesan', 'enctype' => 'multipart/form-data', 'class' => 'myForm')); ?>
    ...
    <?php if($data->status == 'ongoing'): ?>
        ...
        <?php else: ?>
            <?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/submit', array('id' => 'form-submit-actbud', 'enctype' => 'multipart/form-data')); ?>
...
<?php if($data->status !== 'cancel' && $data->status !== 'approved'): ?>
<?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/hapus-pesan', array('class' => 'myForm')); ?>
...
<?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/hapus-pesan-reply', array('class' => 'myForm')); ?>
...
<?php if($data->status == 'ongoing'): ?>
    <!--  Modal buat kegiatan -->
<?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/buat-rincian-kegiatan', array('class' => 'myForm')); ?>
...
<!-- Modal ubah actbud -->
<!--<?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/ubah-actbud', array('class' => 'myForm')); ?>
...
<?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/upload-dokumen-pendukung', array('enctype' => 'multipart/form-data', 'class' => 'myForm')); ?>    
...
<?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/batalkan-actbud', array('class' => 'myForm')); ?>    
...
<?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/hapus-dokumen-pendukung', array('class' => 'myForm')); ?>    
...
<?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/hapus-rincian-kegiatan'); ?>    
...
<script>    
    ...
    $(document).ready(function(){        
        ...
        <?php if(!empty($rincian_kegiatan->result() && $data->status == 'ongoing')): ?>        
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('ig.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/ig/users/sponsorship/v_detail_actbud.blade.php ENDPATH**/ ?>