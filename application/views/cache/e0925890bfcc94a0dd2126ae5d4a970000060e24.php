...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12">
        <div class="card-box">
            ...
            <?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/buat_pencairan/create?id=' . $id_uraian, array('id' => 'wizard-validation-form', 'class' => 'myForm')); ?>
