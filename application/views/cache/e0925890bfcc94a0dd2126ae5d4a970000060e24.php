...
<?php $__env->startSection('title', 'Sponsorship - Buat Pencairan'); ?>

<?php $__env->startSection('page-title'); ?>
    <a href="<?php echo e($_SERVER['HTTP_REFERER']); ?>"><i class="mdi mdi-arrow-left"></i></a> Buat Pencairan
...
<li class="breadcrumb-item active"><a href="<?php echo e(base_url('app/sim-ig/sponsorship/pencairan')); ?>"><i class="mdi mdi-cash-register"></i> Pencairan</a></li>
<li class="breadcrumb-item"><a href="<?php echo e(base_url('app/sim-ig/sponsorship/pencairan')); ?>"><b><i class="mdi mdi-file-document-outline"></i> <?php echo e($data->kode_uraian); ?></a></b></li>
...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12">
        <div class="card-box">
            ...
            <?php echo form_open('app/sim-ig/sponsorship/pencairan/v_detail/' . $id_uraian . '/buat_pencairan/create?id=' . encrypt($data->id), array('id' => 'wizard-validation-form', 'class' => 'myForm')); ?>
                ...
                <div>
                    ...
                    <section>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <textarea name="nama_kegiatan" id="nama_kegiatan" class="form-control" cols="3" rows="3" required readonly><?php echo e($data->nama_hibah_sponsorship); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('ig.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/ig/users/sponsorship/buat_pencairan.blade.php ENDPATH**/ ?>