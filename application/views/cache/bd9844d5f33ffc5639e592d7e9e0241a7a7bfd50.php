...
<?php $__env->startSection('page-title'); ?>
    <a href="<?php echo e(base_url('app/sponsorship')); ?>"><i class="mdi mdi-arrow-left"></i></a> Detail Kegiatan
...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12">
        <div class="card">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <p class="form-control-static">
                                <b><i class="mdi mdi-account"></i> <?php echo e($data->nama_karyawan); ?> (<?php echo e($data->nama_unit); ?>)</b>
                            </p>
                        </div>
                    </div>               
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <p class="form-control-static">
                                <b><?php echo e($data->nama_hibah_sponsorship); ?></b>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-12">
            ...
            <!--<div class="card-footer">
                ...
                <a href="javascript:void(0)" data-id="<?php echo e(encrypt($data->id)); ?>" data-nama_sponsorship="<?php echo e($data->nama_hibah_sponsorship); ?>" 
    ...
    <!--  Modal edit -->
    <?php echo form_open('app/sponsorship/v_detail/' . $CI->uri->segment(4) . '/edit_sponsorship', array('id' => 'form-ubah')); ?>
    ...
    <?php echo form_open('app/sponsorship/v_detail/' . $CI->uri->segment(4) . '/batalkan_kegiatan'); ?>
    ...
    <?php echo form_open('app/sponsorship/v_detail/' . $CI->uri->segment(4) . '/finalisasi'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\hibah_upj\application\views/users/sponsorship/v_detail_sponsorship.blade.php ENDPATH**/ ?>