            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo $data->nama_hibah_sponsorship; ?></p>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Deskripsi Kegiatan</label>
                        <p class="form-control-static"><?php echo $data->uraian_kegiatan; ?></p>
                    </div>
                </div>                
                <div class="col-md-4">
                    <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('ig.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/ig/users/hibah/v_detail_pencairan.blade.php ENDPATH**/ ?>