...
<?php $__env->startSection('title'); ?>
    RKAT - Ubah PIC Pada RKAT Operasional
    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?= base_url('app/sim-spa/rkat/pic/operasional') ?>">Operasional</a>
                </li>
                <li class="nav-item">
            ...
            <div class="table-responsive my-4">
                <table class="table table-striped table-bordered table-hover" id="table-pic-rkat-operasional" style="width:100%;">
                    <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <tbody id="tbody-pic-rkat-operasional">
                    </tbody>
                </table>
            </div>
        </div>
...
<script>
    $(document).ready(function(){
        $('#tbody-pic-rkat-operasional').on('click', '.btn-edit', function(){
        ...
        $("#table-pic-rkat-operasional").DataTable({
            initComplete: function() {
                var api = this.api();
                $('#table-pic-rkat-operasional_filter input')
                    .off('.DT')
            ...
            serverSide: true,
            ajax: {
                "url": "<?php echo base_url('SPA/RKAT/get_pic_rkat_operasional') ?>",
                "type": "POST",
                "dataType" : "json",
                "data" : {
            ...
            columnDefs: [
                { "targets": 0, "sortable": false, "searchable": true },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('spa.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/spa/rkat/ubah-pic-operasional.blade.php ENDPATH**/ ?>