...
<?php $__env->startSection('title'); ?>
    RKAT <?= $tahunRKAT ?> - List Operasional
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive my-4">
                <table class="table table-striped table-bordered table-hover" id="table-list-rkat-operasional" style="width:100%;">
                    <thead>
                        <tr>
...
<script>
    $(document).ready(function(){
        $("#table-list-rkat-operasional").DataTable({
            oLanguage: {
                sProcessing: "Loading..."
            },
            lengthMenu: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('spa.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_php_7\htdocs\hibah_upj\application\views/spa/rkat/list-operasional.blade.php ENDPATH**/ ?>