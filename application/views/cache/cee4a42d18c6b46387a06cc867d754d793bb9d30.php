                            ...
                            <tr>
                                ...
                                <th class="text-center" style="vertical-align: middle;">
                                    ...
                                    <span class="" style="font-size: 12px;">                                         
                                        <?php if($jabatan != 0): ?>
                                            <?php echo e(ucfirst($row['nama_pic'])); ?>

                                        <?php else: ?>
                                            <?php echo ucfirst($row['nama_pic']).' <br>('.$row['pic'].', '.$row['nama_unit_pic'].')'; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hibah_upj_dev\application\views/users/realisasi_anggaran/index.blade.php ENDPATH**/ ?>