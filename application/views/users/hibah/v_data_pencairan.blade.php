                        ...
                        @endphp
                            @foreach ($data['data'] as $row)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <a href="{{ base_url('app/hibah/pencairan/v_detail/' . encrypt($row['id']) . '/buat_pencairan') }}" class="badge bg-primary btn-sm">Buat Pencairan <i class="mdi mdi-arrow-right"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
