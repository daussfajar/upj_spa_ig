...
@section('page-title')
    <a href="{{ base_url('app/hibah/pencairan') }}"><i class="mdi mdi-arrow-left"></i></a> Pencairan
@endsection
...
<li class="breadcrumb-item active"><a href="{{ base_url('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5)) }}"><b><i class="mdi mdi-file-document-outline"></i> {{ $data->kode_uraian }}</a></b></li>
@endsection
    ...
    <div class="card">
        ...
        <div class="card-body">                      
            ...
            <div class="float-right mb-3">
                <a href="{{ base_url('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/buat_pencairan') }}" class="btn btn-success btn-sm">+ Buat Pencairan</a>
            </div>  
