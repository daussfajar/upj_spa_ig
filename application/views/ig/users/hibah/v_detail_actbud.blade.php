...
<div class="col-md-12">
    ...
    {!! form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/buat_pesan', array('id' => 'form-pesan', 'enctype' => 'multipart/form-data', 'class' => 'myForm')) !!}
    ...
    @if ($data->status == 'ongoing')
        ...
        @else
            {!! form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/submit', array('id' => 'form-submit-actbud', 'enctype' => 'multipart/form-data')) !!}
                <div class="card-box">        
                    <div class="alert alert-info">
                        <p class="mb-0"><i class="mdi mdi-information-variant"></i> Sebelum submit, pastikan anda sudah mengisi detail biaya dengan benar.</p>                        
                    </div>
...
@if ($data->status !== 'cancel' && $data->status !== 'approved')
{!! form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/hapus-pesan', array('class' => 'myForm')) !!}
    <!-- modal hapus pesan -->
...
@if ($data->status == 'ongoing')
    <!--  Modal buat kegiatan -->
{!! form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/buat-rincian-kegiatan', array('class' => 'myForm')) !!}
...
<!-- Modal ubah actbud -->
<!--{!! form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/ubah-actbud', array('class' => 'myForm')) !!}
...
{!! form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/upload-dokumen-pendukung', array('enctype' => 'multipart/form-data', 'class' => 'myForm')) !!}    
...
{!! form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/batalkan-actbud', array('class' => 'myForm')) !!}    
...
{!! form_open('app/hibah/pencairan/v_detail/' . $CI->uri->segment(5) . '/actbud/' . $CI->uri->segment(7) . '/hapus-dokumen-pendukung', array('class' => 'myForm')) !!}    
