...
@section('page-title')
<a href="{{ base_url('app/sim-ig/hibah/status_pencairan') }}"><i class="mdi mdi-arrow-left"></i></a> Detail Kegiatan
@endsection
...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ base_url('app/sim-ig/hibah') }}"><i class="mdi mdi-briefcase-outline"></i> Hibah</a></li>
<li class="breadcrumb-item"><a href="{{ $CI->uri->segment(4) == 'pencairan' ? base_url('app/sim-ig/hibah/pencairan') : base_url('app/sim-ig/hibah/status_pencairan') }}"><i class="mdi mdi-cash-register"></i> {{ $CI->uri->segment(4) == 'pencairan' ? 'Pencairan' : 'Status Pencairan' }}</a></li>
<li class="breadcrumb-item"><a href="javascript:void(0)"><b><i class="mdi mdi-file-document-outline"></i> {{ $data->kode_uraian }}</a></b></li>
...
@if ($data->status !== 'ongoing')
    <div class="col-md-12">
        ...
        @include('ig.users.hibah.tracker_status_actbud')
    </div>        
@endif
...
<div class="col-md-12">
    <div class="card card-border card-teal">
        ...
        @if ($data->status == 'approved')
            <div class="card-footer">
                <div class="float-right">                    
                    <a href="javascript:void(0)" onclick="window.open('{{ base_url('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/cetak_form_actbud?pdf=true') }}')" class="btn btn-primary btn-sm"><i class="mdi mdi-printer"></i></a>
                </div>
            </div>
        @endif
        <!--<div class="card-footer">
    ...
    @if ($data->status == 'ongoing')
        ...
        @else
            {!! form_open('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/submit', array('id' => 'form-submit-actbud', 'enctype' => 'multipart/form-data')) !!}
                <div class="card-box">        
                    <div class="alert alert-info">
                        <p class="mb-0"><i class="mdi mdi-information-variant"></i> Sebelum submit, pastikan anda sudah mengisi detail biaya dengan benar.</p>                        
                    </div>
...
@if ($data->status == 'ongoing')
    <!--  Modal buat kegiatan -->
{!! form_open('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/buat-rincian-kegiatan', array('class' => 'myForm')) !!}
...
<!-- Modal ubah actbud -->
<!--{!! form_open('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/ubah-actbud', array('class' => 'myForm')) !!}
...
{!! form_open('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/batalkan-actbud', array('class' => 'myForm')) !!}    
...
{!! form_open('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/actbud/' . $id_actbud . '/hapus-dokumen-pendukung', array('class' => 'myForm')) !!}    
...
<script>    
    ...
    $(document).ready(function(){        
        ...
        @if (!empty($rincian_kegiatan->result() && $data->status == 'ongoing'))        
