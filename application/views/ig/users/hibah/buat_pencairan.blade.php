...
@section('page-title')
    <a href="{{ base_url('app/sim-ig/hibah/pencairan') }}"><i class="mdi mdi-arrow-left"></i></a> Buat Pencairan
@endsection
...
<li class="breadcrumb-item"><a href="{{ base_url('app/sim-ig/hibah/pencairan') }}"><i class="mdi mdi-cash-register"></i> Pencairan</a></li>
...
@section('content')
    <div class="col-md-12">
        <div class="card-box">
            ...
            {!! form_open('app/sim-ig/hibah/pencairan/v_detail/' . $id_uraian . '/buat_pencairan/create?id=' . $id_uraian, array('id' => 'wizard-validation-form')) !!}
