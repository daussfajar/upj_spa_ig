        ...
        <div class="card-box mt-2">
            <div class="row mb-3">                    
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <form action="{{ base_url('app/sim-ig/realisasi_anggaran') }}" method="GET" accept-charset="utf-8" autocomplete="off" class="myForm">
                        ...
                        @foreach ($data['data'] as $row)
                            ...
                            <tr>
                                ...
                                <th style="vertical-align: middle;font-weight:bold;" title="Tanggal Pembuatan: {{ $row['tanggal_pembuatan'] }}">
                                    <a href="{{ base_url('app/sim-ig/realisasi_anggaran/history/v_detail/' . encrypt($row['id_uraian']) . '/actbud/' . encrypt($row['id'])) }}" class="badge bg-primary p-2">
                                ...
                                <td class="text-center" style="vertical-align:middle;">
                                    <a href="{{ base_url('app/sim-ig/realisasi_anggaran/actbud/' . encrypt($row['id']) . '/' . encrypt($row['id_uraian'])) }}" class="">
