...
@section('content')
            ...
            <div class="row mb-3">                    
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="float-left">
                        <a href="{{ base_url('app/sim-ig/sponsorship/buat_kegiatan') }}" class="btn btn-success btn-sm"><i class="mdi mdi-plus"></i> Tambah Data</a>
                    </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <form action="{{ base_url('app/sim-ig/sponsorship') }}" method="GET" accept-charset="utf-8" autocomplete="off">                        
    ...
    {!! form_open('app/sim-ig/sponsorship/preview_upload', array('enctype' => 'multipart/form-data', 'class' => 'myForm')) !!}
