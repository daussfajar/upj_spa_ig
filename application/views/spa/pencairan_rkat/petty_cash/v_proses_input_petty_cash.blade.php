...
@section('title')
    <?= MOD2 ?> Pencairan RKAT - Input Petty Cash - {{ $data['uraian'] }}
@endsection

@section('page-title')
    <a href="{{ base_url('app/sim-spa/pencairan-rkat/input-petty-cash') }}"><i class="mdi mdi-arrow-left"></i></a> Input Petty Cash
@endsection
...
@section('content')
    <?php if($sisa_agr > 0){ ?>
    {!! form_open(base_url('app/sim-spa/pencairan-rkat/input-petty-cash/' . $id), array('class' => 'myForm')) !!}
    <?php } ?>    
    <div class="col-lg-12">
        <div class="card">
