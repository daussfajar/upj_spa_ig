    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?= base_url('app/sim-spa/admin/rkat/pic/operasional') ?>">Operasional</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('app/sim-spa/admin/rkat/pic/investasi') ?>">Investasi</a>
                </li>
            </ul>
...
<script>
    $(document).ready(function(){
        ...
        $("#table-pic-rkat-operasional").DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "<?php echo base_url('SPA/Admin/RKAT/get_pic_rkat_operasional') ?>",
                "type": "POST",
                "dataType" : "json",
                "data" : {},
            },
