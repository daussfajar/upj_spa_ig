...
<div class="col-lg-12">
    {!! form_open('app/sim-spa/approval/keuangan/kirim-persetujuan/' . encrypt($kd_act), array('class' => 'myForm')) !!}
    <div class="card">
        <div class="card-header">
        Form Persetujuan
        </div>
...
<div class="col-lg-12">
    {!! form_open('app/sim-spa/approval/keuangan/kirim-pesan/' . encrypt($kd_act), array('class' => 'myForm')) !!}
        <div class="card">
            <div class="card-header">
