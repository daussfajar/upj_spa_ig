...
<?php endif; ?>
<?php } ?>
<li class="breadcrumb-item active"><a href="javascript: void(0);" style="color:blueviolet;"><i class="mdi mdi-file-document"></i>{{ $kd_act }}</a></li>
@endsection
...
@section('content')
			...
			<div class="card-header border-teal bg-transparent">
				...
				<div class="float-right">
					...
					<span class="badge bg-primary p-2" style="font-weight:bold;">
						<i class="mdi mdi-file-document"></i> {{ $actbud[0]['kode_pencairan'] }}
					</span>
					<span class="badge bg-info p-2" style="font-weight:bold;">
						<i class="mdi mdi-clipboard-check"></i> {{ ($actbud[0]['jns_aju_agr'] == "actbud") ? "ACT" : "PTY" }}/{{ $kd_act }}
					</span>
					@switch($actbud[0]['status_act'])
					@case('send')
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							...
							<p class="form-control-static" style="font-size: 14px;">{{ $unit['nama_unit'] }}</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label for="">Nama Kegiatan</label>
							<p class="form-control-static" style="font-size: 14px;">{{ $actbud[0]['deskrip_keg'] }}</p>
						</div>
					</div>                
					<div class="col-md-4">
						<div class="form-group">
							<label for="">KPI</label>
							<p class="form-control-static" style="font-size: 14px;">{{ $actbud[0]['kpi'] }}</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							...
							<p class="form-control-static">
								<span class="" style="font-size: 14px;">
									{{ $actbud[0]['nama_lengkap'] . ' (' . $actbud[0]['pic'] . ')' }}
								</span>
							</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							...
							<p class="form-control-static">
								<span class="" style="font-size: 14px;">
									{{ $nm['nama_lengkap'] . ' (' . $actbud[0]['pelaksana'] . ')' }}
								</span>
							</p>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<p class="form-control-static">
								@if (!empty($actbud[0]['tanggal_pembuatan']))
									<?php 
	...
	<div class="col-md-12">
					...
					<table class="table table-bordered table-hover table-striped dataTable">
						<thead>
							<tr>
								...
								@if ($actbud[0]['status_act'] == 'belum dikirim')
									<th class="text-center">Aksi</th>
								@endif

								@if ($actbud[0]['status_act'] == 'send')
		...
		{!! form_open('app/sim-spa/approval/'.$CI->uri->segment(4).'/detail/' . $kd_act, array('id' => 'form-pesan', 'enctype' => 'multipart/form-data', 'class' => 'myForm')) !!}		
        ...
        {!! form_open($urlKirimPersetujuan, array('id' => 'form-persetujuan', 'class' => 'myForm')) !!}	
        <div class="card">
