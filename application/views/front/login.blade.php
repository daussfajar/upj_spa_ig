...
<head>
	...
	<link rel="stylesheet" href="{{ base_url('assets/css/inputs.css') }}">
				...
				<div class="col-md-8 col-lg-6 col-xl-5">                    
					<div class="card">                        
						<div class="mb-text bg-white mb-logo">
							<div class="mt-4">
								<a href="{{ base_url() }}" class="text-success">
									<span><img src="{{ base_url('assets/images/logo/upjlogo.png') }}" alt="" height="80"></span>                                    
								</a>
							</div>
						</div>
                        ...
                        ">
                            ...
                            {!! form_open('auth/login?_g_id=' . generateRandomString(32) . '&gl=' . encrypt('gl') . $ex_act, array('autocomplete' => 'on', 'id' => 'loginForm')) !!}
