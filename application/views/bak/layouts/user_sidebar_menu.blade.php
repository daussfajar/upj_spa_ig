        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li class="<?= menu_active(2, 'dashboard', 'mm-active') ?>">
                    <a href="{{ base_url('app/dashboard') }}" class="waves-effect waves-light <?= menu_active(2, 'dashboard', 'active') ?>">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                @if ($unit == 'Bagian Keuangan' || $jabatan == 0 || $jabatan == 22 || $jabatan == 6)
                                    <li class="<?= $CI->uri->segment(2) == 'hibah' && $CI->uri->segment(3) == 'buat_kegiatan' ? 'mm-active' : '' ?>">
                                        <a href="{{ base_url('app/hibah') }}" class="<?= menu_active(3, 'buat_kegiatan', 'active') ?>">Kegiatan</a>
                                    </li>
                                @endif                       
        
                                <li class="<?= $CI->uri->segment(2) == 'hibah' && $CI->uri->segment(3) == 'pencairan' ? 'mm-active' : '' ?>">
                                    <a href="{{ base_url('app/hibah/pencairan') }}" class="<?= menu_active(3, 'pencairan', 'active') ?>">                                        
                                        <span>Pencairan</span>
                                    </a>
                                </li>                                
                                <li class="<?= $CI->uri->segment(2) == 'hibah' && $CI->uri->segment(3) == 'status_pencairan' ? 'mm-active' : '' ?>">
                                    <a href="{{ base_url('app/hibah/status_pencairan') }}" class="<?= menu_active(3, 'status_pencairan', 'active') ?>">
                        ...
                        <li class="<?= menu_active(2, 'sponsorship', 'mm-active') ?>">
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                ...
                                <li class="<?= $CI->uri->segment(2) == 'sponsorship' && $CI->uri->segment(3) == 'buat_kegiatan' ? 'mm-active' : '' ?>">
                                    <a href="{{ base_url('app/sponsorship') }}" class="<?= menu_active(3, 'buat_kegiatan', 'active') ?>">Kegiatan</a>
                                </li>
                                @endif
                                <li class="<?= $CI->uri->segment(2) == 'sponsorship' && $CI->uri->segment(3) == 'pencairan' ? 'mm-active' : '' ?>">
                                    <a href="{{ base_url('app/sponsorship/pencairan') }}" class="">Pencairan</a>
                                </li>
                                <li class="<?= $CI->uri->segment(2) == 'sponsorship' && $CI->uri->segment(3) == 'status_pencairan' ? 'mm-active' : '' ?>">
                                    <a href="{{ base_url('app/sponsorship/status_pencairan') }}" class="<?= menu_active(3, 'status_pencairan', 'active') ?>">Status Pencairan</a>
                                </li>
                            </ul>      
                        </li>
                        ...
                        @if ($unit == 'Bagian Keuangan' || $jabatan == 0 || $jabatan == 22 || $jabatan == 6)
                            <li class="<?= menu_active(2, 'kredit_saldo', 'mm-active') ?>">
                                <a href="{{ base_url('app/kredit_saldo') }}" class="waves-effect waves-light <?= menu_active(2, 'kredit_saldo', 'active') ?>"> 
                        ...
                        <li class="<?= menu_active(2, 'realisasi_anggaran', 'mm-active') ?>">
                            <a href="{{ base_url('app/realisasi_anggaran') }}" class="waves-effect waves-light <?= menu_active(2, 'realisasi_anggaran', 'active') ?>">                                
                ...
                @if ($jabatan != 7)
                    <li class="<?= menu_active(2, 'approval', 'mm-active') ?>">
                        <a href="{{ base_url('app/approval') }}" class="waves-effect waves-light <?= menu_active(2, 'approval', 'active') ?>">
                            <i class="mdi mdi-clipboard-file-outline"></i>                                    
                            <span>  Approval  </span>
                        </a>                              
                    </li>
                    <li class="<?= menu_active(2, 'riwayat_approval', 'mm-active') ?>">
                        <a href="{{ base_url('app/riwayat_approval') }}" class="waves-effect waves-light <?= menu_active(2, 'riwayat_approval', 'active') ?>">
                ...
                @if ($jabatan == 0)
                    <li class="<?= menu_active(2, 'master-data', 'mm-active') ?>">
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li>
                                <a href="{{ base_url('app/master-data/karyawan') }}" class="waves-effect waves-light <?= menu_active(3, 'karyawan', 'active') ?>">
                                    <span>  Karyawan  </span>                                 
                                </a>
                            </li>
                            <li>
                                <a href="{{ base_url('app/master-data/unit') }}" class="waves-effect waves-light <?= menu_active(3, 'unit', 'active') ?>">
                                    <span>  Unit/Bagian  </span>                                 
                                </a>
                            </li>
                            <li>
                                <a href="{{ base_url('app/master-data/jabatan') }}" class="waves-effect waves-light <?= menu_active(3, 'jabatan', 'active') ?>">
                                    <span>  Jabatan  </span>                                 
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="<?= menu_active(2, 'pengaturan', 'mm-active') ?>">
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li>
                                <a href="{{ base_url('app/pengaturan/umum') }}" class="waves-effect waves-light <?= menu_active(3, 'umum', 'active') ?>">
                                    <span>  Umum  </span>                                 
                                </a>
                            </li>
                            <li>
                                <a href="{{ base_url('app/pengaturan/login_logs') }}" class="waves-effect waves-light <?= menu_active(3, 'login_logs', 'active') ?>">
                                    <span>  Login Logs  </span>                                 
                                </a>
                            </li>
                            <li>
                                <a href="{{ base_url('app/pengaturan/banned_ip') }}" class="waves-effect waves-light <?= menu_active(3, 'banned_ip', 'active') ?>">
                                    <span>  Banned IP  </span>                                 
                                </a>
                            </li>
                        </ul>
