        ...
        <div class="card-box mt-2">
            <div class="row mb-3">                    
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <form action="{{ base_url('app/sponsorship/status_pencairan') }}" method="GET" accept-charset="utf-8" autocomplete="off">                        
                        ...
                        @endphp
                            @foreach ($data['data'] as $row)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <a href="{{ base_url('app/sponsorship/status_pencairan/v_detail/'.encrypt($row['id_hibah']).'/actbud/'.encrypt($row['id_actbud'])) }}" class="badge bg-info">Lihat</a>
                                    </td>
                                    <td class="text-center" style="vertical-align: middle;">
                                        @if ($row['status_actbud'] == 'approved')
                                            <a href="javascript:void(0)" onclick="window.open('{{ base_url('app/sponsorship/pencairan/v_detail/'.encrypt($row['id_hibah']).'/actbud/'.encrypt($row['id_actbud']).'/cetak_form_actbud?pdf=true') }}', 'MsgWindow', 'width=800,height=800')" class="btn btn-primary btn-xs text-white"><i class="mdi mdi-printer"></i></a>
                                        @else
                                        -
                                        @endif
                                    </td>
