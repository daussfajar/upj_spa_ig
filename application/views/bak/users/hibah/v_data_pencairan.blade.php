        ...
        <div class="card-box mt-2">
            <div class="row mb-3">                    
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <form action="{{ base_url('app/hibah/pencairan') }}" class="myForm" method="GET" accept-charset="utf-8" autocomplete="off">                        
                        ...
                        @endphp
                            @foreach ($data['data'] as $row)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <a href="{{ base_url('app/hibah/pencairan/v_detail/' . encrypt($row['id']) . '/buat_pencairan') }}" class="badge bg-primary p-2 btn-sm">Buat Pencairan <i class="mdi mdi-arrow-right"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
