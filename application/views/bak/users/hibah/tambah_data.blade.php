...
@section('title', 'Hibah - Create')

@section('page-title')
    <a href="{{ base_url('app/hibah') }}"><i class="mdi mdi-arrow-left"></i></a> Create Hibah
@endsection
...
@section('content')
    <div class="col-md-12">
        <div class="card-box">
            ...
            {!! form_open('app/hibah/buat_kegiatan/submit', array('id' => 'wizard-validation-form')) !!}
                <div>
                    <h3>Step 1</h3>
                    <section>
