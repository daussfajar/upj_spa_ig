...
@section('title', 'Hibah - Preview Upload')

@section('page-title')
   <a href="{{ base_url('app/hibah') }}"><i class="mdi mdi-arrow-left"></i></a> Upload Excel
@endsection
...
@section('content')
    <div class="col-md-12">
        <div class="card-box">            
            ...
            {!! form_open('app/hibah/preview_upload/upload', array('autocomplete' => 'off', 'accept-charset' => 'utf-8')) !!}
                    ...
                    <tbody>
                        ...
                        @foreach ($sheet as $row)
                            ...
                            @if ($numrow > 1)
                                ...
                                <input type="hidden" name="kode_sub_aktivitas[]" value="{{ $kode_sub_aktivitas }}">
                                <input type="hidden" name="indikator_kerja_umum[]" value="{{ $indikator_kerja_umum }}">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" {!! $td_kode_sub_aktivitas !!}>
                                        {{ $kode_sub_aktivitas }}
                                    </td>
                                    <td class="text-center" {!! $td_indikator_kerja_umum !!}>
                                        {{ $indikator_kerja_umum }}
                                    </td>
