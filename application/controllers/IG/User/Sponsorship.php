...
class Sponsorship extends CI_Controller {
	...
	public function v_buat_kegiatan(){
		$kode_uraian 			= $this->Sponsorship_model->get_kode_uraian_sponsorship();		
	...
	public function submit_buat_kegiatan(){
		...
		$this->form_validation->set_rules('nama_sponsorship', 'Nama Sponsorship', 'trim|required', [
			'required' => '%s tidak boleh kosong.'
		]);
		...
		if($this->form_validation->run() === TRUE){
			...
			$insert = $this->Sponsorship_model->insert_kegiatan_sponsorship($data);
			
			if($insert['success'] === TRUE){

				$this->session->set_flashdata('alert', [
					'message' => 'Selamat anda berhasil membuat kegiatan sponsorship.',
					'type'    => 'success',	
					'title'   => ''
				]);
	...
	public function v_detail_sponsorship(){
	...
	public function edit_sponsorship(){
		...
		if($this->form_validation->run() === TRUE){
			...
			$update = $this->Sponsorship_model->edit_kegiatan_sponsorship($id, $data);
			
			if($update['success'] === TRUE){
				$this->session->set_flashdata('alert', [
					'message' => 'Selamat anda berhasil mengubah kegiatan sponsorship.',
					'type'    => 'success',	
					'title'   => ''
				]);
				return redirect(base_url('app/sim-ig/sponsorship'));
	...
	public function batalkan_kegiatan(){
		...
		if($this->form_validation->run() === TRUE){
			...
			$this->session->set_flashdata('alert', [
				'message' => 'Selamat anda berhasil membatalkan kegiatan sponsorship.',
				'type'    => 'success',	
				'title'   => ''
			]);
			return redirect(base_url('app/sim-ig/sponsorship'));
	...
	public function upload_sponsorship(){
		...
		if($this->form_validation->run() === TRUE){
			...
			$this->session->set_flashdata('alert', [
				'message' => 'Selamat anda berhasil upload sponsorship.',
				'type'    => 'success',	
				'title'   => ''
			]);
			return redirect(base_url('app/sim-ig/sponsorship'));
